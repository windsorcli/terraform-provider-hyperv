...
// Pin the contract pieces that MUST appear in common/preamble.ps1. If
...
// it as silent stderr noise or path-encoding corruption. Every line
// below is load-bearing on PS 5.1.
