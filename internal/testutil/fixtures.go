...
const VMGen2FixtureJSON = `{
	...
	"SnapshotFileLocation": "E:\\VMs\\sample-vm\\Snapshots",
	"SmartPagingFilePath": "E:\\VMs\\sample-vm\\SmartPaging",
...
const VMGen1FixtureJSON = `{
	...
	"Notes": "",
	"Path": "C:\\ProgramData\\Microsoft\\Windows\\Hyper-V\\Virtual Machines",
	"SnapshotFileLocation": "C:\\ProgramData\\Microsoft\\Windows\\Hyper-V\\Snapshots",
	"SmartPagingFilePath": "C:\\ProgramData\\Microsoft\\Windows\\Hyper-V\\SmartPaging",
